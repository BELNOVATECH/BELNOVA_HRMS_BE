...
def create_employee_service(
    ...
    try:
        ...
        created_employee = (
            ...
            .filter(
                EmployeeRegistration.id == employee.id
            )
            .first()
        )
...
def get_all_employees_service(db: Session):
    ...
    employees = (
        db.query(
            ...
            EmployeeRegistration.emp_code,
            EmployeeRegistration.first_name,
            EmployeeRegistration.last_name,
            EmployeeRegistration.email,
            EmployeeRegistration.mobile,
            EmployeeRegistration.status_id,
            MasterDepartment.department,
            MasterDesignation.designation_name
        )
        .outerjoin(
            MasterDepartment,
            EmployeeRegistration.department_id == MasterDepartment.id
        )
        .outerjoin(
            MasterDesignation,
            EmployeeRegistration.designation_id == MasterDesignation.id
        )
        .all()
    )
